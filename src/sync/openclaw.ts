...
import type { OpenClawMcpServer } from "../types/openclaw"
...
function convertMcpForOpenClaw(
  servers: Record<string, ClaudeMcpServer>,
): Record<string, OpenClawMcpServer> {
